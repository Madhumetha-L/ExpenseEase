    ...
    <div class="container-fluid bg-white p-0">
        ...
        <div class="container-fluid py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">Pricing</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Pricing Plans</h1>
                    <p>Choose the plan that fits your needs. Each plan offers a variety of features to help you manage your finances effectively.</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="pricing-card bg-light">
                            <div class="card-header text-center">
                                <h3 class="text-primary mb-0">Basic Plan</h3>
                                <h2 class="text-primary mb-0">$10/month</h2>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="pricing-card bg-light">
                            <div class="card-header text-center">
                                <h3 class="text-success mb-0">Standard Plan</h3>
                                <h2 class="text-success mb-0">$25/month</h2>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="pricing-card bg-light">
                            <div class="card-header text-center">
                                <h3 class="text-warning mb-0">Pro Plan</h3>
                                <h2 class="text-warning mb-0">$50/month</h2>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="pricing-card bg-light">
                            <div class="card-header text-center">
                                <h3 class="text-info mb-0">Enterprise Plan</h3>
                                <h2 class="text-info mb-0">$100/month</h2>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
